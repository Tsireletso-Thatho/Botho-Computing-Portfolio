...
<body>
		<h2>Grades</h2>
		<a href="updategrade.php"><button class="click">UPDATE GRADES</button></a>
		<br>
		<table class="content">
			<thead>
				<tr>
			...
			<tbody>
			    ...
			    while($row = $result->fetch_assoc()){
			    	echo "
						...
						<td>
							<a href='editgrade.php?id={$row['id']}'><button class='btn-click'>UPDATE</button></a>
							<a href='deletegrades.php?id={$row['id']}'><button class='btn-click'>DELETE</button></a>
						</td>
					</tr>
			    	"; 
			    }
